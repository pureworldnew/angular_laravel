...
new Vue({
    ...
    methods: {
        ...
        checkProductAvail: function (productId, resultId) {
            ...
            var prodStartDateObj = this.addTimeToDate(this.products[resultId].startDateTimeObj, this.products[resultId].startTime);
        ...
        // on click it should first show the filter first
...
/*
        ...
        addItemToBooking: function (bookingId, shoppingCartItem, cartIndex) {
            ...
            var startDateTimeObj = this.addTimeToDate(shoppingCartItem.startDateTimeObj, shoppingCartItem.startTime);
