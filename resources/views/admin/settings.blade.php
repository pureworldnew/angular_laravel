                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="information">
                        ...
                        <div class="form-group" style="position: relative">
                         ...
                         <div class="form-group">
                            {!! Form::label('Behöver logga in för att boka', trans ('admin/settings.needlogin')) !!}<br>
                            <select name="NeedLogin" class="form-control" id="NeedLogin">
                             @if($centre->NeedLogin == 'av') <!-- Off-->
                                  ...
                                  <option value="på">{{trans ('admin/settings.no')}}</option>
                              @elseif($centre->NeedLogin == 'på')<!-- On-->
                                  <option  value="av">{{trans ('admin/settings.yes')}}</option>
                                  <option selected="selected" value="på">{{trans ('admin/settings.no')}}</option>
                              @endif
                            </select>
                        </div>
                    </div>
