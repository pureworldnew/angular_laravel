                ...
                <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        ...
                        @if(Session::has('address'))
                            ...
                            <input class="form-control" readonly="readonly" value="{{ Session::get('address') }}" id="address"  name="address"/>
                        @else
                    ...
                    <div class="form-group">
                        ...
                        @if(Session::has('zipcode'))
                            <label for="post_code"><i class="zmdi zmdi-post_code"></i></label>
                            <input class="form-control" readonly="readonly" value="{{ Session::get('zipcode') }}" id="post_code"  name="post_code"/>
                        @else
                    ...
                    <div class="form-group">
                        ...
                        @if(Session::has('city'))
                            ...
                            <input class="form-control" readonly="readonly" value="{{ Session::get('city') }}" id="city"  name="city"/>
                        @else
                    ...
                    <div class="form-group">
                        {!! Form::text('telephone', $booking->telephone ? $booking->telephone : (Auth::check() ?
                        Auth::user()->centres->first()->telephone : ""), array('class' => 'form-control', 'placeholder'
                        => trans('booking/confirm.telephone'))) !!}
                    ...
                    <div class="form-group">
                        {!! Form::textarea('freeText', $booking->freeText ? $booking->freeText : "", array('class' =>
                        'form-control', 'placeholder' => trans('booking/confirm.freeText'))) !!}
                    </div>
                    @endif
