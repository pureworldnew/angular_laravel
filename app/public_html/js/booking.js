    ...
    new Vue({
        ...
        data: {
           ...
           // showYouChosen: false,
            ...
            deleteSureMessage: $('#deleteSureMessage').html(),
            totalPrice: 0,
        ...
        methods: {
            ...
            getPriceAvail: function(resultId)
            {
                var that = this;
                var quantity = parseInt(this.results[resultId].quantity, 10);

                if(quantity != 0 && (
                    (this.results[resultId].durationDays === undefined || this.results[resultId].durationDays == 0) &&
                    !(this.results[resultId].durationHours === undefined || this.results[resultId].durationHours == 0))
                )
                {
                    this.getPrice(this.results[resultId].id, this.getStartDateTimeString(resultId), this.getEndDateTimeString(resultId), quantity, resultId);
                }
            ...
            getPrice: function(productId, startDateTime, endDateTime, quantity, resultId) {
            ...
            getProductAvailability: function (resultId, startDateTime, endDateTime, quantity) {
            ...
            displaySearchResults: function(response) {
                ...
                responseData.forEach(function(result, key){
                    ...
                    var result = Object.assign({}, responseData[key], {
                        ...
                        //quantity: 0,per_type_times_local
                        durationDays: "",
                        quantity: "",
                        hasPriceAvailCriteria: false
                    });
            ...
            addToBooking: function (productId, resultId, productAvailable, availMessage) {
                ...
                if(productAvailable) {
                    ...
                    this.results.forEach(function (resultItem) {
                        ...
                        {
                            that.addToShoppingCart(resultItem);
            ...
            addToShoppingCart: function(resultItem)
            {
                ...
                //this.totalPrice += resultItem.price;
            ...
            addToCart: function (productId, resultId) {
                ...
                var formattedProdStartDateTime = this.getStartDateTimeString(resultId);
                var formattedProdEndDateTime = this.getEndDateTimeString(resultId);

                this.getProductAvailability(resultId, formattedProdStartDateTime, formattedProdEndDateTime, this.results[resultId].quantity);
                ...
                $.ajax({
                    ...
                    success: function (bookingDetails) {
                       ...
                       // that.totalPrice = parseFloat(that.totalPrice,10) + parseFloat(bookSplit[2], 10);
                        that.totalPriceCalc();
                        var cartItem = Object.assign({}, that.shoppingCart[0], { bookingLocationId: bookSplit[1], re: bookSplit[2] })
